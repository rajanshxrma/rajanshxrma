...
- **[langchain-apple-foundation-models](https://github.com/rajanshxrma/langchain-apple-foundation-models)** — the first LangChain provider for Apple's on-device models, published on PyPI and verified against LangChain's own compliance test suite.
